...
export function getGoldPredictionToolDefinition() {
  return {
    ...
    function: {
      ...
      description:
        "Get the latest live and historical gold (GLD) price data along with a statistical prediction for the next trading period. Use this whenever the user asks about gold price direction, gold predictions, or whether gold will go up or down -- AND ALSO use this whenever the user asks about the gold prediction system's methodology, data sources, historical data range, number of data points, whether it uses news, or asks you to prove/verify/explain what data or method the gold prediction is based on. Any question about how the gold prediction works or what it's based on requires calling this function to get real data -- never answer such questions from general knowledge or guesswork.",
      parameters: {
        type: "object",
        properties: {
          horizon: {
