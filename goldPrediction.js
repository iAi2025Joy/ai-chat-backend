...
// Applies the model's already-computed predicted PERCENTAGE change to a
// genuinely fresh live price, instead of using the (possibly up to an
// hour old) cached dollar figures directly. Falls back cleanly to the
// cached numbers if the live fetch fails for any reason -- a prediction
// should never break just because one extra live-price call had a
// hiccup.
