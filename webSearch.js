...
export function formatSearchResultsForModel(query, searchData) {
  ...
  block +=
    ...
    "clickable. Do not just repeat a snippet verbatim -- summarize in your own words. " +
