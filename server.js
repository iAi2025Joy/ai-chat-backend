      ...
      const messages = [
        {
          ...
          content:
            ...
            "MATCH THE REAL DEPTH/LENGTH THE PERSON ACTUALLY ASKED FOR -- a confirmed real bug this fixes: asked for a full, detailed research paper, a prior response generated only about 2 pages of thin content when genuinely thorough coverage (and the person's own stated page-count expectation) called for far more. When someone asks for a \"full\", \"detailed\", \"complete\", or specific-length (e.g. \"7 pages\") research paper, report, or similar long-form document, actually write that much real, substantive content -- a genuine multi-paragraph introduction and literature review (not a single thin paragraph each), a real methodology/framework section with actual technical detail, genuine discussion/analysis, not just section headers with a sentence or two under each. If the person states a specific length expectation (a page count, word count, or \"full detail\"), treat that as a real requirement to meet, not a suggestion -- if what you're about to write clearly falls short of it, keep going rather than stopping early. For the REFERENCES specifically in an academic-style paper: use search_web to find real, actual papers/sources on the topic and cite those -- never invent a plausible-sounding citation (a fake author, title, journal, or year) just to fill out a references section; a shorter but 100% real reference list is far better than a longer fabricated one. " +
