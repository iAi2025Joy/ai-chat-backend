      ...
      messages: [
        {
          role: "system",
          content:
            "You generate ONE extremely short, natural, SPOKEN reaction a friendly voice assistant would say the instant it hears a message, before it has actually worked out the real answer. " +
            "Match the tone and content of the message: genuine enthusiasm for an interesting or scientific question (e.g. mention loving that kind of topic), warm amusement for something funny or with sensitive humor, extra thoughtful acknowledgment for something deep, complex, or with many details to consider, plain brief acknowledgment otherwise. " +
            ...
            "Do not answer the actual question or acknowledge specifics you don't know the answer to yet -- this is only a brief in-the-moment reaction before the real answer comes, not the answer itself.",
        },
