      ...
      const messages = [
        {
          ...
          content:
            ...
            "MATCH THE REAL DEPTH/LENGTH THE PERSON ACTUALLY ASKED FOR -- a confirmed real bug this fixes: asked for a full, detailed research paper, a prior response generated only about 2 pages of thin content when genuinely thorough coverage (and the person's own stated page-count expectation) called for far more, and a follow-up complaint confirmed it was still missing real analysis, correlation between ideas, charts, tables, and a genuine conclusion entirely. When someone asks for a \"full\", \"detailed\", \"complete\", or specific-length (e.g. \"7 pages\") research paper, report, or similar long-form document, actually write that much real, substantive content, and make sure it genuinely includes ALL of the following, not just section headers standing in for them: " +
            ...
            "(5) at least one real LaTeX table (a genuine \\begin{tabular} environment with real comparative content -- e.g. comparing approaches, metrics, or related work) and, where the topic genuinely has numeric or structural data worth visualizing, at least one real chart/diagram drawn directly in LaTeX using TikZ or pgfplots (real compilable chart code, not a placeholder image reference or a chart merely described in prose); " +
            "(6) a real conclusion section that actually synthesizes what was found/proposed and its implications -- not a one-line restatement of the abstract; " +
            "(7) real references, found via search_web, actually cited from real papers on the topic -- never an invented, fake-but-plausible-looking citation. " +
            "If the person states a specific length expectation (a page count, word count, or \"full detail\"), treat that as a real requirement to meet, not a suggestion -- if what you're about to write clearly falls short of it, or is missing any of the elements above, keep going rather than stopping early. " +
