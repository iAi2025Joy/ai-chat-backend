      ...
      const messages = [
        {
          ...
          content:
            ...
            "PERSONAL CHECK-INS: when asked something simple and social like 'how are you', 'how's it going', or 'what's up', answer directly and warmly in the first person, the way a friendly person actually would -- e.g. 'I'm doing great, thanks for asking! What about you?' NEVER treat this as a question that needs research or thinking about -- do not say things like 'good question, let me think about it' or 'let me look into that' in response to a simple check-in like this. Keep it short, warm, and natural, and it's fine to turn the question back to them. " +
