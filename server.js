...
const instituteData = {
  ...
  garnet:
    "GARNET-26 (also called Garnet) is an AI chatbot developed and under ongoing training by the Institute of AI (iAi). " +
    "It's designed to provide general assistance to users in a similar spirit to other AI chatbots such as ChatGPT, Gemini, or Claude -- " +
    "answering questions, helping with information, and having natural conversations. " +
    "What sets GARNET-26 apart is a specialized focus: alongside general assistance, it studies the gold market and works to generate " +
    "the most accurate forecasts it can for future gold prices, using real historical price data and statistical testing rather than guesswork. " +
    "It's built and refined by the Institute of AI as part of the Institute's broader work in AI-driven predictive analytics.",
  garnetServices:
    "**GARNET-26** offers two kinds of help: general AI assistant capabilities, and a specialized focus on the gold market.\n\n" +
    "## General assistance\n" +
    "Like other AI chatbots, GARNET-26 can help with everyday questions and tasks -- explaining a concept, drafting or improving text, brainstorming ideas, or just having a conversation. For example, you could ask it to explain how inflation affects currency values, help you draft an email, or summarize a topic you're curious about.\n\n" +
    "## Gold market focus\n" +
    "This is GARNET-26's specialty. It can:\n" +
    "- Give a statistical prediction for gold's likely next-period direction and price, based on real historical data -- e.g. \"What's your prediction for gold tomorrow?\"\n" +
    ...
    "- Explain what data and methodology its predictions are based on, honestly -- e.g. \"What data does your prediction use, and how accurate is it?\"\n" +
    "- Search the web for current gold-market news and context when needed -- e.g. \"What's driving gold prices today?\"\n\n" +
    "GARNET-26 always presents predictions as statistical estimates, not financial advice, and is upfront when a prediction hasn't shown a reliable edge over simply assuming prices stay the same.",
};
  ...
  try {
    ...
    if (lower.includes("founder") || lower.includes("founded") || lower.includes("who started"))
      ...
      (lower.includes("service") ||
        ...
        lower.includes("what could you") ||
        lower.includes("help me with") ||
        lower.includes("capabilit"))
    )
      answer = instituteData.garnetServices;
    else if (
      lower.includes("service") ||
      lower.includes("offer") ||
      lower.includes("do you do")
      ...
      const messages = [
        {
          ...
          content:
            ...
            "If asked about gold prices generally (direction, forecast, current price), use the appropriate function (get_gold_prediction, get_live_gold_price, or search_web as described in each tool) -- and always state clearly that any prediction is a statistical estimate, not financial advice. You have access to the recent conversation history -- use it naturally, e.g. resolve pronouns and follow-up questions ('what about next week', 'why', 'tell me more') using what was actually said earlier in this conversation, rather than treating every message as if it's the first one.",
        },
