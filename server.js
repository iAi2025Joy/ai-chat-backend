...
const GARNET_REALTIME_INSTRUCTIONS =
  ...
  "You have tools for gold, oil, and dollar-index (DXY) price predictions, live prices, and web search -- use them whenever the user asks about these topics rather than guessing or using outdated knowledge. Always mention that financial predictions are not financial advice. " +
