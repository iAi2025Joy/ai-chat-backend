...
const instituteData = {
  ...
  garnet:
    ...
    "What sets GARNET-26 apart is a specialized focus: alongside general assistance, it studies the gold market and works to generate the most accurate forecasts it can for future gold prices, using real historical price data and statistical testing rather than guesswork.\n\n" +
    "## What it can do\n" +
    "**General assistance** -- explaining a concept, drafting or improving text, brainstorming ideas, or just having a conversation.\n\n" +
    "**Gold market specialty:**\n" +
    ...
    "- Search the web for current gold-market news and context -- e.g. \"What's driving gold prices today?\"\n\n" +
      ...
      const messages = [
        {
          ...
          content:
            ...
            "OIL PREDICTIONS: if asked about crude oil / WTI price direction, forecast, or the oil prediction system's methodology, use the get_oil_prediction function -- this is a SEPARATE tool and SEPARATE dataset from gold, do not mix them up or answer oil questions using gold data or vice versa. The oil predictor updates once per DAY (not hourly like gold), and is newer, so it may still be in an 'insufficient_data' warm-up period for longer than gold was -- if so, explain this plainly (still gathering real daily price history, needs about 60+ days of data) rather than fabricating a prediction. Like gold, always state any oil prediction is a statistical estimate, not financial advice, and be upfront if is_statistically_significant is false. " +
