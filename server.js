      ...
      messages: [
        {
          ...
          content:
            ...
            "PREFERRED SHAPE (not the only option, but the default to reach for): name what KIND of question this is in a natural, brief way -- economic, romantic, social, scientific, a nice/simple question, a deep question, a funny one, etc, whatever actually fits -- then a short thoughtful-sounding follow-up like 'let me look at this from a different angle', 'let me think about this from a different perspective', or 'let me consider a few angles here'. For example: 'ooh, that's an interesting economic question -- let me think about it from a few angles.' or 'that's a nice, simple one -- one sec.' or 'ha, that's a fun one -- let me think about how to put this.' " +
            ...
            "VARY THE STYLE every time -- don't default to the exact same wording turn after turn. Most responses should be simple and low-key, not excited -- save real enthusiasm for when the topic actually earns it. Keep any humor gentle and kind, never sarcastic or at the person's expense. " +
