...
2. Clearly present and explain:
   - Current gold price and model target price
   - Directional prediction (UP/DOWN) along with model confidence / win probability
   - Daily macro news sentiment (BULLISH/BEARISH/NEUTRAL) and sentiment score
   - Top news headlines driving market sentiment
3. Include a concise, responsible financial disclaimer stating that predictions are generated by automated statistical ML models and market sentiment analysis, not professional financial advice.`;
