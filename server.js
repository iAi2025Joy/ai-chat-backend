  ...
  try {
    ...
    if (!answer) {
      ...
      if (responseMessage.tool_calls && responseMessage.tool_calls.length > 0) {
        ...
        // Prepended here in code -- guaranteed correct and guaranteed to
        // actually be the first sentence, regardless of what GPT itself
        // wrote (including if GPT also separately wrote its own version,
        // per the system prompt instruction below telling it not to).
